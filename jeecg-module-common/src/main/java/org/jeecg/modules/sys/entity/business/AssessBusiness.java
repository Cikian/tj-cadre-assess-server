...
/**
 * @Description: 业务工作测评发起
 * @Author: jeecg-boot
 * @Date: 2024-08-22
 * @Version: V1.0
 */
@Data
@TableName("assess_business")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value = "assess_business对象", description = "业务考核发起")
public class AssessBusiness implements Serializable {
     ...
     * 截至日期
     */
    @Excel(name = "截至日期", width = 15, format = "yyyy-MM-dd")
