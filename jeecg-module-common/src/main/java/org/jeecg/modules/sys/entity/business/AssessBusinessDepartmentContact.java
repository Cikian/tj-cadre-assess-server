 ...
 */
@Data
@TableName("assess_business_department_contact")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value = "assess_business_department_contact对象", description = "业务考核单位互评配置")
public class AssessBusinessDepartmentContact implements Serializable {
    ...
    private java.lang.String assessedDepartmentCode;
}
