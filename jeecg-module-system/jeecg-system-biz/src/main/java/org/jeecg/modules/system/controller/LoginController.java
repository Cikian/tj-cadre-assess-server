...
public class LoginController {
    ...
    @ApiOperation("OA登录")
	@RequestMapping(value = "/loginWithOA", method = RequestMethod.POST)
	public Result<JSONObject> loginWithOA(@RequestBody SysLoginModel sysLoginModel){
		Result<JSONObject> result = new Result<JSONObject>();
		String username = sysLoginModel.getUsername();

		SysUser sysUser = null;
		sysUser = sysUserService.checkOaUser(username);
