 ...
 */
@Data
@ApiModel(value = "business_assess_depart_fillPage对象", description = "业务工作测评填报列表")
public class AssessBusinessDepartFillPage {
    ...
    @ExcelCollection(name = "业务工作测评填报项目")
    @ApiModelProperty(value = "业务工作测评填报项目")
