...
public class AssessBusinessLevelRatioController extends JeecgController<AssessBusinessLevelRatio, IAssessBusinessLevelRatioService> {
	...
	public Result<String> add(@RequestBody AssessBusinessLevelRatio assessBusinessLevelRatio) {
		ratioService.save(assessBusinessLevelRatio);
	...
	public Result<String> edit(@RequestBody AssessBusinessLevelRatio assessBusinessLevelRatio) {
		ratioService.updateById(assessBusinessLevelRatio);
